...
class MyTopo( Topo ):
    ...
    def __init__( self ):
        ...
        linkopts = dict(bw=1000, delay='5ms',loss=50)
        linkopts2 = dict(bw=100, delay='5ms', loss=50)
        ...
        self.addLink( switch1, switch2 , **linkopts2)
        ...
        self.addLink( switch3, switch1, **linkopts2 )
